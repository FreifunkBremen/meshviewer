    ...
    'linkInfos': [
      {
        ...
        'image': 'https://grafana.bremen.freifunk.net/render/d-solo/nvSNqoHmz/link?panelId=7&var-node={SOURCE_ID}&var-nodetolink={TARGET_ID}&from=now-86399s&width=650&height=350&theme=light',
    ...
    'linkTypeInfos': [
      {
        ...
        'image': 'https://grafana.bremen.freifunk.net/render/d-solo/nvSNqoHmz/link?panelId=8&var-node={SOURCE_ID}&var-nodetolink={TARGET_ID}&var-source_addr={SOURCE_ADDR}&var-target_addr={TARGET_ADDR}&from=now-86399s&width=650&height=350&theme=light',
